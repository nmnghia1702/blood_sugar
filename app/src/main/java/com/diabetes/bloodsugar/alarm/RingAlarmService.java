...
import com.diabetes.bloodsugar.activity.RingAlarmActivity;
...
public class RingAlarmService extends Service implements SensorEventListener, AudioFocusController.OnAudioFocusChangeListener {
    ...
    public static final String EXTRA_NO_OF_TIMES_SNOOZED = "com.diabetes.bloodsugar.NO_OF_TIMES_SNOOZED";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Kill SnoozeAlarmService if it is running for a different alarm.
        if (SnoozeAlarmService.isThisServiceRunning && SnoozeAlarmService.alarmID != alarmID) {
            stopService(new Intent(this, SnoozeAlarmService.class));
        }
    ...
    private Notification buildRingNotification() {
        ...
        Intent fullScreenIntent = new Intent(this, RingAlarmActivity.class)
    ...
    private void snoozeAlarm() {
        ...
        if (alarmDetails.getBoolean(ConstantsAndStatics.BUNDLE_KEY_IS_SNOOZE_ON)) {
            ...
            if (numberOfTimesTheAlarmHasBeenSnoozed < alarmDetails.getInt(ConstantsAndStatics.BUNDLE_KEY_SNOOZE_FREQUENCY)) {
                ...
                Intent intent = new Intent(this, SnoozeAlarmService.class)
